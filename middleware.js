...
export async function middleware(request) {
  ...
  const publicPaths = ['/', '/investors', '/methodology', '/access', '/blog', '/login', '/signup', '/accept-invite', '/demo', '/campus-os', '/api/whitepaper-request', '/api/whitepaper-download', '/api/auth', '/api/enrollments', '/api/invites', '/api/request-access', '/api/approve-access']
