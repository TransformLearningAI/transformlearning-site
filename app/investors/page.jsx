...
export const metadata = {
  title: 'Investor Overview — Restricted Access — Arrival',
  description: 'Request access to the Arrival go-to-market strategy and investor materials.',
}
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <p className="text-sm text-brand-gray leading-relaxed mb-3">
          The Arrival Investor Overview contains our go-to-market strategy, market definition, pricing model,
          sales approach, financial projections, and competitive positioning for higher education.
        </p>
        <p className="text-sm text-brand-gray leading-relaxed mb-8">
          Access is available to qualified investors, advisors, institutional leaders, and strategic partners.
        </p>
        <Link href="/access"
