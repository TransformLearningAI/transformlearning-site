/**
 * Campus Transformation Blog
 * Voice: Direct, experienced, empathetic toward boards/presidents.
 * Not academic. Not consulting-speak. Honest.
 */

export const CT_POSTS = [
  {
    slug: 'your-first-client-will-almost-kill-you',
...
But it also laid bare the core problem of being a new organization with no track record, reaching out to an institution that is drowning.

**The Perils**

Let me be blunt about what could go wrong here, because I think honesty about risk is more useful than optimism about outcomes.
...
jeff@transformlearning.ai`
  },
  {
    ...
    title: 'A Historic Part of America\'s Education Infrastructure Is Disappearing',
    date: '2026-06-15',
    author: 'Jeff Ritter',
    summary: 'Colleges that were once places of innovation and tradition are closing at a rate of two per week. We treat bridges as infrastructure but let campuses be demolished. A national education policy framework for what comes next.',
...
The president earning $200,000 to $350,000 with a campus residence has a personal incentive to keep the institution open as long as possible. The board members who joined to help their alma mater don't want to be the ones who "killed the college." The tenured professor with a mortgage in a town with no other colleges can't afford the uncertainty. The maintenance worker who kept the boiler running for 20 years has no safety net. The community wants their college to stay a college because that's what they know.

Every person in the room has a reason to delay. And delay is what kills campuses. Not the enrollment cliff. Not the demographics. Delay.

A campus that transforms proactively, with 18 months of planning and its best people still on staff, has a fundamentally different outcome than one that transforms reactively after the money is gone. The difference is almost entirely explained by how long the decision was delayed.

The way out: name it. Say it out loud in the boardroom. Then address it. Transition plans for presidents. Cover for boards through external assessment. Individual paths for faculty. Job guarantees for staff. Community design sessions so the town builds what comes next instead of having it done to them.

The campuses that transform successfully are the ones where someone was brave enough to say: "This is going to be hard for all of us individually. And it is still the right thing to do."
...
jeff@transformlearning.ai`
  },
  {
    ...
    date: '2026-05-21',
    author: 'Jeff Ritter',
    summary: 'Oakland City University just suspended all undergraduate programs. 170 employees face layoff. But ten miles down the road, Toyota just invested $200 million. The campus is worth more than the college.',
...
I offered the university pro bono consulting this week. Whether they take me up on it or not, the situation at Oakland City illustrates something important about the crisis in American higher education: the campus is almost always worth more than the college.

What everyone sees: a small Baptist university in rural Indiana, enrollment declining, unable to make payroll. Another casualty.

What I see: a 34-acre campus with five residence halls (two brand new), a science building, a 1,000-seat arena, classrooms, and a library. A campus that has been the anchor of a town of 2,259 people for 141 years. And ten miles down the road, Toyota Motor Manufacturing Indiana, 7,300 employees, $200 million in fresh investment this March, over $800 million total, 1,400 new jobs, and a workforce training gap they're already partnering with Purdue and Ivy Tech to fill.

The gap between what Oakland City has and what Gibson County needs is not money. It's not technology. It's imagination.

There are programs that could launch on that campus within months using existing WIOA workforce funding, existing employer partnerships, and the skills of the 170 people who just lost their jobs. There are residence halls built in 2019 and 2023 that could house workforce trainees this fall.

The question isn't whether Oakland City University can survive as a traditional college. The question is what that campus can become if someone is willing to ask a bigger question than "how do we get back to where we were?"

A town of 2,259 people shouldn't lose its anchor without someone at least trying.
...
It doesn't. And the colleges that most need a new cake are the ones who can least afford to find that out the slow way.`
  ...
  {
    slug: 'the-buildings-are-trying-to-tell-us-something',
    title: 'The Buildings Are Trying to Tell Us Something',
    date: '2026-05-11',
    author: 'Jeff Ritter',
    summary: 'Public schools are shrinking. Colleges are closing. The buildings are still there. What if we stopped waiting for the grim reaper and started planning the next chapter while there\'s still time?',
    body: `The New York Times reported this week what anyone near a school already knows: public school enrollment has dropped in 30 states. The biggest factor is simple — fewer children. The U.S. fertility rate peaked in 2007 and has fallen 24% since. Add school choice, homeschooling, charter schools, virtual learning, housing costs pushing families out of cities, and a crackdown on immigration that had been quietly buoying enrollment numbers, and you get a picture that isn't going to reverse itself.

NYC alone is projected to lose 153,000 students by 2035. Los Angeles, Chicago, and dozens of smaller districts are shrinking at similar rates. West Virginia has lost 13.6% of its K-12 students. Mississippi, 12%. New Hampshire, 11%.

**But here's the thing nobody's saying:** this isn't just a K-12 problem. This is the same demographic cliff that's been closing colleges for the past five years — and it's now hitting the pipeline that feeds them. Fewer kids in kindergarten today means fewer freshmen in 2038. The wave is only getting bigger.

**The Buildings Know**

If you drive through Pittsburgh, you'll see what happens when schools close. Some of the most beautiful condos in the city were once public schools — high ceilings, original chalkboards still mounted in the living rooms, gymnasium windows flooding loft apartments with light. They're gorgeous. They're also a monument to a community asset that was sold to a developer instead of reimagined for the people who live there.

The same thing is starting to happen with college campuses. Pittsburgh Technical College — 180 acres in Oakdale, professional kitchens, trades buildings, 461 dorm beds — closed in 2024 and is listed for sale. Penn State is closing seven campuses by 2027. Hampshire College, Fontbonne University, Siena Heights, Lourdes, Northland, Trinity Christian — the list grows every month.

Most of these campuses will follow the same path as those Pittsburgh schools: sold, converted, condos. The community loses its gathering space, its cultural anchor, its workforce pipeline. A developer gets a good deal on square footage. Everybody moves on.

**Or They Don't Have to**

Here's what I keep thinking about: what if we stopped waiting for the grim reaper to show up at the board meeting? What if a campus with a year or two of runway left started planning a transformation instead of being forced into irrelevance — or worse, condos?

A closing campus doesn't have to be an ending. With planning — real planning, not the kind where you hire a consultant to produce a report nobody reads — a campus can become something bigger than it ever was as a college. A workforce training center for the trades and certifications employers are begging for. A community learning hub serving everyone from teenagers to retirees. A small-business incubator. A K-12 outdoor education center. An event venue. A health clinic. A gathering place.

Not a college. Something better. Something that serves 15,000 people a year instead of 1,500 students. Something that doesn't depend on 18-year-olds choosing your school over a hundred others. Something that's flexible and agile enough to move with the times instead of fighting them.

**The Window Is Now**

The campuses that act while they still have runway — while the staff is still there, while the buildings are still maintained, while the community still identifies with the place — those are the ones that get to write a different ending. The ones that wait until the last board meeting, the final press release, the "thank you for 100 years of service" — those become condos.

I've seen it happen too many times. I taught for 25 years at a university where enrollment declined every single year I was there. The conversation was always about survival — how to recruit more students, how to cut more costs, how to stretch the endowment one more year. Nobody ever said: "What if we became something else? Something the community actually needs more than another small college?"
...
*Jeff Ritter, PhD, is the founder of [Campus Transformation at Transform Learning](/campus-transformation). He spent 25 years as a professor and now helps boards and communities reimagine what their campuses can become.*`,
  },
  {
    ...
    date: '2026-05-06',
    author: 'Jeff Ritter',
    summary: 'Many colleges are in trouble. But a closure doesn\'t have to be the end. With bold leadership, a closing campus can become something far bigger.',
...
*Jeff Ritter is a retired professor and ed-tech entrepreneur. He founded Campus Transformation to help small colleges and the regions they anchor reimagine themselves as workforce and creative development catalysts.*`,
  ...
  {
    slug: 'what-your-board-isnt-hearing',
    title: 'What Your Board Isn\'t Hearing — And Why It Matters',
    date: '2026-05-08',
    author: 'Jeff Ritter',
    summary: 'Most boards of trustees get enrollment reports, financial statements, and retention numbers. What they don\'t get is anyone telling them there\'s a third option between "cut more" and "close."',
    body: `Most boards of trustees at struggling colleges get the same three things at every meeting: enrollment numbers (down), financial statements (tight), and retention rates (worrying). The president delivers them with practiced calm. The board asks questions. Everyone agrees to "monitor the situation" and reconvenes in three months.
...
**Why Boards Don't Hear About Option Three**
