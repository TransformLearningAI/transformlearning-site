              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur-xl">
                <div className="mb-4 flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-400">Your constellation of foundational and core skills. Click any star.</p>
                  </div>
                        ...
                        return (
                          <button key={node.id} onClick={() => setSelectedSkill(node.id)}
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-[10px] text-slate-400">{node.skill_type === 'implicit' ? 'core' : 'foundational'}</div>
                            </div>
                  ...
                  <div className="rounded-[2rem] border border-white/10 bg-slate-900/70 p-5">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full"
                        ...
                        {sel?.skill_type === 'implicit' ? 'core' : 'foundational'}
                      </span>
                    </div>
              ...
              <Link key={node.id} href={`/my-progress/${enrollmentId}/skill/${node.id}`}
                ...
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full"
                    ...
                    {node.skill_type === 'implicit' ? 'core' : 'foundational'}
                  </span>
                </div>
