...
const STEPS = [
  {
    ...
    body: 'The platform maps any syllabus into a complete skill and knowledge framework. No faculty dashboard to learn, no workflow to change, no ongoing workload. Faculty provide the course — we build the intelligence behind it.',
