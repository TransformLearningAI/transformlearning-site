  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0A0E1A' }}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="px-6 py-3 flex items-center gap-4 sticky top-0 z-10" style={{ background: '#0D1117', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <button
            className="lg:hidden p-2 rounded-lg hover:bg-white/5"
            onClick={() => setSidebarOpen(true)}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M3 6h14M3 10h14M3 14h14" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
          </button>
          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 rounded-xl text-sm text-white placeholder-white/20 focus:outline-none transition-colors"
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setShowTour(true)}
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/10 text-xs font-medium text-white/30 hover:text-white/50 transition-colors">
            ...
            {/* Classes dropdown */}
            <button className="hidden sm:flex items-center gap-1 px-3 py-1.5 rounded-lg border border-white/10 text-xs font-medium text-white/30 hover:text-white/50 transition-colors">
              Classes
            ...
            <button className="relative p-2 rounded-lg hover:bg-gray-50 transition-colors">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M13.5 6.75a4.5 4.5 0 10-9 0c0 5.25-2.25 6.75-2.25 6.75h13.5s-2.25-1.5-2.25-6.75z" stroke="rgba(255,255,255,0.25)" strokeWidth="1.5" strokeLinejoin="round"/>
                <path d="M10.3 15.75a1.5 1.5 0 01-2.6 0" stroke="rgba(255,255,255,0.25)" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
