      ...
      <div className="relative flex-1 max-w-6xl mx-auto w-full px-6 pt-16 pb-8 grid lg:grid-cols-[1fr_440px] gap-12 items-center">
        ...
        <div>
          ...
          <p className={`text-base text-white/55 leading-relaxed max-w-lg mb-10 transition-all duration-700 delay-300 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            Transform Learning maps any syllabus into a complete skill framework — explicit and implicit — then surfaces each student's true proficiency level. Students don't just see where they stand. They get personalized coaching, adaptive quizzes, study guides, and practice to close every gap before it becomes a grade.
          </p>
